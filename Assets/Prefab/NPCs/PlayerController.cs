...
public class PlayerController : PrimitiveScript {
	...
	public void respawn(){
		...
		network.networkView.RPC("updateBool", RPCMode.All, agentToUpdateIdx, "Dead", anim.GetBool("Dead"));
		
		// Make the player invisible until they respawn
		network.networkView.RPC("networkWideShowOrHideAgent", RPCMode.All, agentToUpdateIdx, false);
		...
		network.networkView.RPC("networkWideShowOrHideAgent", RPCMode.All, agentToUpdateIdx, true);
